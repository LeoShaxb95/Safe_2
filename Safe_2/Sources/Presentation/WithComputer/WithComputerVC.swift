...
final class WithComputerVC: BaseVC {
    ...
    func coloringButtons() {
        easyButton.backgroundColor = .systemGreen
        normalButton.backgroundColor = .systemYellow
    ...
    @objc func sliderValueDidChange(_ sender: UISlider) {
        ...
        currentFiniksLabel.text = "\(currentSliderValue) Finiks"
    ...
    @objc func didTapDifficultyButton(sender: UIButton) {
        ...
        case 0:
            easyButton.backgroundColor = .systemGreen
            finiksSlider.tintColor = .systemGreen
            winFiniksLabel.textColor = .systemGreen
            winMultiplier = 50
        case 1:
            normalButton.backgroundColor = .systemYellow
            finiksSlider.tintColor = .systemYellow
            winFiniksLabel.textColor = .systemYellow
            winMultiplier = 85
        case 2:
            hardButton.backgroundColor = .systemRed
            finiksSlider.tintColor = .systemRed
            winFiniksLabel.textColor = .systemRed
            winMultiplier = 120
...
//        var index = StartPageViewController.gameStyleIndex
//        switch index {
//        case 1:
//            nextVC = GuessOnlyViewController()
//        case 2:
//            nextVC = WithComputerViewController()
//        default:
//            print("Mrint")
//
//        }
